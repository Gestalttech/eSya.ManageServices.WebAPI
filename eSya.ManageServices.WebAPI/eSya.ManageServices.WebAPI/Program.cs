using eSya.ManageServices.WebAPI.Utility;
using eSya.ManageServices.WebAPI.Filters;
using Microsoft.Extensions.Configuration;
using DL_ManageServices = eSya.ManageServices.DL.Entities;
using eSya.ManageServices.IF;
using eSya.ManageServices.DL.Repository;
using Microsoft.Extensions.Localization;
using eSya.ManageServices.DL.Localization;
...
DL_ManageServices.eSyaEnterprise._connString = builder.Configuration.GetConnectionString("dbConn_eSyaEnterprise");
...
builder.Services.AddScoped<IClinicalServiceManagementRepository, ClinicalServiceManagementRepository>();
